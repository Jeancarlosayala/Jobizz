...
const Register = () => {
  ...
  useEffect(() => {
    setField({ name: name, email: emailInput, password: passwordInput, confirmPassword: confirmPasswordInput })
    ...
    <View className='bg-[#FAFAFD] px-[25px] h-full'>
      <SafeAreaView>
        ...
        <View className='mt-[51px]'>
          ...
          <TouchableOpacity onPress={() => handlerRegister()} className='mt-[32px]' style={style.button}>
            <Text style={style.textButton}>Register</Text>
          </TouchableOpacity>
        </View>

        <View className='items-center mt-[275px] flex-row justify-center'>
          <Text style={style.textRegular} className='text-[#BDBEC2]'>Have an account? </Text>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <Text style={style.textRegular} className='text-[#356899]'>Log in</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </View>
